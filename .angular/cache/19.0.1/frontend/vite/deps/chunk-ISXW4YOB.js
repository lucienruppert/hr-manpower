...
function getParentBlockHydrationQueue(deferBlockId, injector) {
  ...
  while (!isTopMostDeferBlock && currentBlockId) {
    ngDevMode && assertEqual(deferBlockQueue.indexOf(currentBlockId), -1, "Internal error: defer block hierarchy has a cycle.");
...
function cleanupDeferBlock(deferBlock, hydratedBlocks, injector) {
  return __async(this, null, function* () {
    if (deferBlock !== null) {
...
function triggerHydrationFromBlockName(injector, blockName, replayFn = () => {
}) {
  return __async(this, null, function* () {
    const {
      deferBlock,
      hydratedBlocks
    } = yield triggerBlockTreeHydrationByName(injector, blockName);
    replayFn(hydratedBlocks);
    yield cleanupDeferBlock(deferBlock, hydratedBlocks, injector);
  });
}
...
function triggerBlockTreeHydrationByName(injector, blockName) {
  return __async(this, null, function* () {
    const dehydratedBlockRegistry = injector.get(DEHYDRATED_BLOCK_REGISTRY);
    if (dehydratedBlockRegistry.hydrating.has(blockName)) return {
      deferBlock: null,
      hydratedBlocks: /* @__PURE__ */ new Set()
    };
    ...
    for (const dehydratedBlockId of hydrationQueue) {
      yield triggerAndWaitForCompletion(dehydratedBlockId, dehydratedBlockRegistry, injector);
    }
  ...
  return __async(this, null, function* () {
    if (elementTriggers.length > 0) {
      ...
      for (let elementTrigger of elementTriggers) {
        const cleanupFn = onViewport(elementTrigger.el, () => __async(this, null, function* () {
          yield triggerHydrationFromBlockName(injector, elementTrigger.blockName);
        }), injector);
        registry.addCleanupFn(elementTrigger.blockName, cleanupFn);
      }
    }
...
function setTimerTriggers(injector, elementTriggers) {
  return __async(this, null, function* () {
    for (const elementTrigger of elementTriggers) {
      const registry = injector.get(DEHYDRATED_BLOCK_REGISTRY);
      const onInvoke = () => __async(this, null, function* () {
        return yield triggerHydrationFromBlockName(injector, elementTrigger.blockName);
      });
...
function hydrateAndInvokeBlockListeners(blockName, injector, event, currentTarget) {
  return __async(this, null, function* () {
    ...
    yield triggerHydrationFromBlockName(injector, blockName, replayQueuedBlockEvents);
  });
}
...
var AfterRenderEffectSequence = class extends AfterRenderSequence {
  ...
  constructor(impl, effectHooks, scheduler, destroyRef) {
    super(impl, [void 0, void 0, void 0, void 0], false, destroyRef);
    this.scheduler = scheduler;
    for (const phase of AFTER_RENDER_PHASES) {
...
function afterRenderEffect(callbackOrSpec, options) {
  ...
  const sequence = new AfterRenderEffectSequence(manager.impl, [spec.earlyRead, spec.write, spec.mixedReadWrite, spec.read], scheduler, injector.get(DestroyRef));
  manager.impl.register(sequence);
  return sequence;
}
var ResourceStatus;
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-ISXW4YOB.js.map
